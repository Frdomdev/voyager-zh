        ...
        <form role="form" action="@if(isset($dataTypeContent->id)){{ route('voyager.posts.update', $dataTypeContent->id) }}@else{{ route('voyager.posts.store') }}@endif" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="voyager-character"></i> {{ trans('voyager.Post Title') }}
                                <span class="panel-desc"> {{ trans('voyager.The title for your post') }}</span>
                            </h3>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-book"></i> {{ trans('voyager.Post Content') }}</h3>
                            <div class="panel-actions">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">{{ trans('voyager.Excerpt') }} <small>{{ trans('voyager.Small description of this post') }}</small></h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-clipboard"></i> {{ trans('voyager.Post Details') }}</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="form-group">
                                <label for="name">{{ trans('voyager.URL slug') }}</label>
                            ...
                            <div class="form-group">
                                <label for="name">{{ trans('voyager.Post Status') }}</label>
                            ...
                            <div class="form-group">
                                <label for="name">{{ trans('voyager.Post Category') }}</label>
                            ...
                            <div class="form-group">
                                <label for="name">{{ trans('voyager.Featured') }}</label>
                    ...
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-image"></i> {{ trans('voyager.Post Image') }}</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-bordered panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-search"></i> {{ trans('voyager.SEO Content') }}</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="form-group">
                                <label for="name">{{ trans('voyager.Meta Description') }}</label>
                            ...
                            <div class="form-group">
                                <label for="name">{{ trans('voyager.Meta Keywords') }}</label>
                            ...
                            <div class="form-group">
                                <label for="name">{{ trans('voyager.SEO Title') }}</label>
            ...
            <button type="submit" class="btn btn-primary pull-right">
                @if(isset($dataTypeContent->id))  {{ trans("voyager.Update Post") }} @else <i class="icon wb-plus-circle"></i> {{ trans("voyager.Create New Post") }}   @endif
            </button>
        </form>
