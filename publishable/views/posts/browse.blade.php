                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        @if (isset($dataType->server_side) && $dataType->server_side)
                            <div class="pull-left">
                                <div role="status" class="show-res" aria-live="polite">{{trans('voyager.Showing')}} {{ $dataTypeContent->firstItem() }} to {{ $dataTypeContent->lastItem() }} of {{ $dataTypeContent->total() }} {{trans('voyager.entries')}}</div>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default pull-right" data-dismiss="modal">{{trans('voyager.View')}}</button>
                </div>
            </div>
        </div>
    </div>
