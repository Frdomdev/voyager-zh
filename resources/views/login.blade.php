...
<head>
    ...
    <title>{{trans('voyager.Admin Login')}}</title>
    {{-- Voyager CSS --}}
...
<body class="login-page">
    ...
    <div id="login_section">
        <div class="content">
            ...
            <p>{{trans('voyager.Sign in below')}}:</p>
            <div style="clear:both"></div>
            <form action="{{ route('voyager.login') }}" method="POST" id="login">
                ...
                <button class="btn btn-primary btn-login" id="voyager-login-btn">
                    <span class="login_text"><i class="voyager-lock"></i> {{trans('voyager.Login')}}</span>
                    <span class="login_loader">
                        <i class="voyager-lock"></i> {{trans('voyager.Logging in...')}}
                    </span>
                </button>
            ...
            @if (count($errors))
                <div class="error-login">
                    {{trans("voyager.The given credentials dont match with an user registered")}}.
                </div>
            @endif
</div>
</div>
