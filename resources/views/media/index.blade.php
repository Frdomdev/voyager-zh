        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="admin-section-title">
                    <h3><i class="voyager-images"></i> {{trans('voyager.media')}}</h3>
                </div>
                <div class="clear"></div>
                ...
                <div id="filemanager">
                    ...
                    <div id="content">
                        ...
                        <div class="breadcrumb-container">
                            ...
                            <div class="toggle"><span>{{trans('voyager.Close')}}</span><i class="voyager-double-right"></i></div>
                        </div>
                        <div class="flex">
                            ...
                            <div id="left">
                                ...
                                <div id="file_loader">
                                    ...
                                    @endif
                                    <p>{{trans('voyager.LOADING YOUR MEDIA FILES')}}</p>
                                </div>

                                <div id="no_files">
                                    <h3><i class="voyager-meh"></i> {{trans('voyager.No files in this folder')}}</h3>
                                </div>
                            ...
                            <div id="right">
                                <div class="right_none_selected">
                                    ...
                                    <p>{{trans('voyager.No File or Folder Selected')}}</p>
                                </div>
                                    ...
                                    <div class="detail_img @{{ selected_file.type }}">
                                        ...
                                        <template v-if="selected_file.type.includes('video')">
                                            <video width="100%" height="auto" controls>
                                                ...
                                                {{trans('voyager.Your browser does not support the video tag')}}
                                            </video>
                                        </template>
                                        <template v-if="selected_file.type.includes('audio')">
                                            <audio controls style="width:100%; margin-top:5px;">
                                                ...
                                                {{trans('voyager.Your browser does not support the audio element')}}
                                            </audio>
                                        </template>
							...
							<span><h4>{{trans('voyager.Title')}}:</h4>
							<p>@{{selected_file.name}}</p></span>
                                        <span><h4>{{trans('voyager.Type')}}:</h4>
							<p>@{{selected_file.type}}</p></span>
                                        <template v-if="selected_file.type != 'folder'">
								<span><h4>{{trans('voyager.Size')}}:</h4>
								<p><span class="selected_file_count">@{{ selected_file.items }} {{trans('voyager.item(s)')}}</span><span
                                            class="selected_file_size">@{{selected_file.size}}</span></p></span>
                                            <span><h4>{{trans('voyager.Public URL')}}:</h4>
								<p><a href="@{{ selected_file.path }}" target="_blank">{{trans('voyager.Click Here')}}</a></p></span>
                                            <span><h4>{{trans('voyager.Last Modified')}}:</h4>
                        ...
                        <div class="nothingfound">
                            ...
                            <span>{{trans('voyager.No files here')}}</span>
                        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"><i class="voyager-move"></i> {{trans('voyager.Move File/Folder')}}</h4>
                                </div>

                                <div class="modal-body">
                                    <h4>{{trans('voyager.Destination Folder')}}</h4>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">{{trans('voyager.Cancel')}}</button>
                                    <button type="button" class="btn btn-warning" id="move_btn">{{trans('voyager.Move')}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal"
                                            aria-hidden="true">&times;</button>
                                    <h4 class="modal-title"><i class="voyager-character"></i> {{trans('voyager.Rename File/Folder')}}</h4>
                                </div>

                                <div class="modal-body">
                                    <h4>{{trans('voyager.New File/Folder Name')}}</h4>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">{{trans('voyager.Cancel')}}</button>
                                    <button type="button" class="btn btn-warning" id="rename_btn">{{trans('voyager.Rename')}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">&times;</button>
                                <h4 class="modal-title"><i class="voyager-folder"></i> {{trans('voyager.Add New Folder')}}</h4>
                            </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">{{trans('voyager.Cancel')}}</button>
                                <button type="button" class="btn btn-info" id="new_folder_submit">{{trans('voyager.Create New Folder')}}
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">&times;</button>
                                <h4 class="modal-title"><i class="voyager-warning"></i> {{trans('voyager.Are You Sure')}}</h4>
                            </div>

                            <div class="modal-body">
                                <h4>{{trans('voyager.Are you sure you want to delete')}} '<span class="confirm_delete_name"></span>'</h4>
                                <h5 class="folder_warning"><i class="voyager-warning"></i> {{trans('voyager.Deleting a folder will remove all files and folders contained inside')}}</h5>
                            </div>

                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">{{trans('voyager.Cancel')}}</button>
                                <button type="button" class="btn btn-danger" id="confirm_delete">{{trans('voyager.Yes, Delete it!')}}
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">&times;</button>
                                <h4 class="modal-title"><i class="voyager-warning"></i> {{trans('voyager.Drag and drop files or click below to upload')}}</h4>
                            </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-success" data-dismiss="modal">{{trans('voyager.All done')}}</button>
                            </div>
                        </div>
                    </div>
                </div>
