...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-settings"></i> {{trans('voyager.Settings')}}
    </h1>
@stop
...
@section('content')
    ...
    <div class="container-fluid">
        <div class="alert alert-info">
            ...
            <p>{{trans('voyager.You can get the value of each setting anywhere on your site by calling')}} <code>Voyager::setting('key')</code></p>
        </div>
    </div>
    ...
    <div class="page-content container-fluid">
        <form action="{{ route('voyager.settings.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-primary pull-right">{{trans('voyager.Save Settings')}}</button>
        </form>
        ...
        <div class="panel" style="margin-top:10px;">
            <div class="panel-heading new-setting">
                <hr>
                <h3 class="panel-title"><i class="voyager-plus"></i> {{trans('voyager.New Setting')}}</h3>
            </div>
            <div class="panel-body">
                <form action="{{ route('voyager.settings.store') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="col-md-4">
                        <label for="display_name">{{trans('voyager.Name')}}</label>
                        <input type="text" class="form-control" name="display_name">
                    </div>
                    <div class="col-md-4">
                        <label for="key">{{trans('voyager.Key')}}</label>
                        <input type="text" class="form-control" name="key">
                    </div>
                    <div class="col-md-4">
                        <label for="asdf">{{trans('voyager.Type')}}</label>
                    ...
                    <div class="col-md-12">
                        <a id="toggle_options"><i class="voyager-double-down"></i> {{trans('voyager.OPTIONS')}}</a>
                        <div class="new-settings-options">
                            <label for="options">{{trans('voyager.Options')}}
                                <small>( {{trans('voyager.optional, only applies to certain types like dropdown box or radio button')}} )
                                </small>
                            </label>
                    ...
                    <button type="submit" class="btn btn-primary pull-right new-setting-btn">
                        <i class="voyager-plus"></i> {{trans('voyager.Add New Setting')}}
                    </button>
                    <div style="clear:both"></div>
                </form>
            </div>
